function configurePageLanguage(language){
    ...
    if(language=="TR"){
        ...
        var newNavbarMenuItems = ["Ana Sayfa", "Hakkımızda", "2024-2025 Eğitim Yılı Süreci", "Hizmetlerimiz", "Sponsorlarımız", "İletişim"];
        ...
        var newBottomNavbarElements = ["Ana Sayfa", "Hakkımızda", "2024-2025 Eğitim Yılı Süreci", "Hizmetlerimiz", "Sponsorlarımız"];
        ...
        var newBottomNavbarElements = ["Startseite", "Über Uns", "Kalender des akademischen Jahres", "Privatunterricht", "Sponsoren", "Kontakt"];
        for(var i=0;i<bottomNavbarElements.length;i++){
            bottomNavbarElements[i].innerText = newBottomNavbarElements[i];
        }
    }
