function configurePageLanguage(language){
    ...
    if(language=="TR"){
        ...
        var enNavbarMenuItems = ["Ana Sayfa", "Hakkımızda", "2025-2026 Eğitim Yılı Süreci", "Sponsorlarımız", "İletişim"];
        ...
        var enBottomNavbarElements = ["Ana Sayfa", "Hakkımızda", "2025-2026 Eğitim Yılı Süreci", "Sponsorlarımız"];
