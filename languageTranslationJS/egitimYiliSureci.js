function configurePageLanguage(language){
    ...
    if(language=="TR"){
        ...
        mainSectionTitle.innerHTML = "2025 - 2026 <br>Eğitim Yılı Süreci";
        ...
        //Changing the language of title
        mainSectionTitle.innerHTML = "2025 - 2026 <br>Academic Year Schedule";
        ...
        //Changing the language of title
        mainSectionTitle.innerHTML = "2025 - 2026 Kalender <br>des akademischen Jahres";
        ...
        //Changing the language of title
        mainSectionTitle.innerHTML = "2025 - 2026 Calendario<br> del Año Académico";
        ...
        //Changing the language of title
        mainSectionTitle.innerHTML = "2025 - 2026 Calendrier<br> de l’année Scolaire";
